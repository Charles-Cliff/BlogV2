...
description: '配置Unity MCP实现AI接管Unity开发自动化，包含VSCode、Rider、Visual Studio三种IDE的完整MCP配置示例'
image: '/images/2025-08/unitymcp.webp'
...
<div>Visual Studio：（这个是我最想喷的，官方给的mcp配置也是云里雾里的。。。目前最新版本是17.14，在你项目下面要建立一�?code>.mcp.json</code>文件才可以，<span style="color: #e03e2d;">重启才能生效！！�?span style="color: #000000;">�?/span></span></div>
<div><span style="color: #e03e2d;"><span style="color: #000000;"><img src="/images/2025-08/image-1755016952760-375474964.webp" alt="Visual Studio MCP配置文件位置"></span></span></div>
